...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.plugin.NumberPrompt": "../../plugin/NumberPrompt.js",
  "Ext.plugin.SlideToRemove": "../../plugin/SlideToRemove.js",
  "PointInTime": "../../app"
});
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "PointInTime.controller.ForgotPassword": [],
  "PointInTime.controller.HomePanel": [],
  "PointInTime.controller.LocationLookup": [],
  "PointInTime.controller.Main": [],
  "PointInTime.controller.PITSelect": [],
  "PointInTime.controller.ProjectManager": [],
  "PointInTime.controller.UserInfo": [],
  "PointInTime.model.AppSettingsModel": [],
  "PointInTime.model.ForgottenPasswordModel": [],
  "PointInTime.model.ObservationSurveyDraftModel": [],
  "PointInTime.model.PITEntryDraftModel": [],
  "PointInTime.model.Project": [],
  "PointInTime.model.ShelteredSurveyDraftModel": [],
  "PointInTime.model.UnshelteredSurveyDraftModel": [],
  "PointInTime.model.UserLoginModelValidator": [],
  "PointInTime.model.UserProjectsModel": [],
  "PointInTime.model.UserSettingsModel": [],
  "PointInTime.model.UserSettingsModelValidator": [],
  "PointInTime.store.AppSettings": [],
  "PointInTime.store.ObservationSurveyDrafts": [],
  "PointInTime.store.PITEntryDrafts": [],
  "PointInTime.store.ShelteredSurveyDrafts": [],
  "PointInTime.store.UnshelteredSurveyDrafts": [],
  "PointInTime.store.UserProjects": [],
  "PointInTime.store.UserSettings": [],
  "PointInTime.utils.Global": [
    "GlobalUtil"
  ],
  "PointInTime.view.AboutPanel": [],
  "PointInTime.view.ForgotPasswordPanel": [],
  "PointInTime.view.Location": [],
  "PointInTime.view.LocationEntry": [],
  "PointInTime.view.Main": [],
  "PointInTime.view.ObservationEntry": [],
  "PointInTime.view.PITDrafts": [],
  "PointInTime.view.PITSelect": [],
  "PointInTime.view.PITTools": [],
  "PointInTime.view.ProjectManager": [],
  "PointInTime.view.SettingsLaunch": [],
  "PointInTime.view.ShelteredEntry": [],
  "PointInTime.view.SurveyHelpPanel": [],
  "PointInTime.view.UnshelteredEntry": [],
  "PointInTime.view.UserInfo": [],
  "PointInTime.view.UserLogin": []
});
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "PointInTime.store.ObservationSurveyDrafts": [
    "store.observationsurveydrafts"
  ],
  "PointInTime.store.PITEntryDrafts": [
    "store.PITEntryDrafts"
  ],
  "PointInTime.store.ShelteredSurveyDrafts": [
    "store.shelteredsurveydrafts"
  ],
  "PointInTime.store.UnshelteredSurveyDrafts": [
    "store.unshelteredsurveydrafts"
  ],
  "PointInTime.store.UserProjects": [
    "store.userprojects"
  ],
  ...
  "PointInTime.view.ForgotPasswordPanel": [
    "widget.forgotpasswordpanel"
  ],
  "PointInTime.view.Location": [
    "widget.locationlookup"
  ],
  "PointInTime.view.LocationEntry": [
    "widget.locationfm"
  ],
  ...
  "PointInTime.view.PITTools": [
    "widget.resourcelookup"
  ],
  "PointInTime.view.ProjectManager": [
    "widget.projectmanager"
  ],
  "PointInTime.view.SettingsLaunch": [
    "widget.settingslaunch"
  ],
  "PointInTime.view.ShelteredEntry": [
    "widget.ShelteredEntry",
    "widget.shelteredentry"
  ],
  "PointInTime.view.SurveyHelpPanel": [
    "widget.surveyhelppanel"
  ],
  "PointInTime.view.UnshelteredEntry": [
    "widget.UnshelteredEntry",
    "widget.unshelteredentry"
  ],
  "PointInTime.view.UserInfo": [
    "widget.userinfo"
