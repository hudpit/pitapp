/**
 * ## Overview
 * Sheltered Entry View.
 *
 * Sencha Touch uses views for user interaction.  From the user's perspective the application is just a series of views.  [Read more about Sencha Touch Views](http://docs.sencha.com/touch/2.4/components/views.html). The sheltered entry panel view is used to display the sheltered entry survey, the view contains a form with survey questions with submit and save draft buttons.
 *
 * The Sheltered survey is similar to the Unsheltered survey {@link PointInTime.view.UnshelteredEntry} and Observation survey {@link PointInTime.view.ObservationEntry}.
 *
 ...
 * {@img shots/sheltered.PNG Sheltered Survey Panel}
 */
Ext.define('PointInTime.view.ShelteredEntry', {
    extend: 'Ext.form.Panel',
    alias: 'widget.ShelteredEntry',
    xtype: 'shelteredentry',
    /**
     * @cfg {Object} config
     * View config object
     */
    ...
    initialize: function() {
        ...
        var xgeolat = this.getLat(), xgeolng = this.getLng(), xmanualaddress = this.getManual_address();
        ...
        mainfieldset.add([
            ...
            },
            {
                ...
                store: {
                    data: [
                        {type: '', title: ''},
                        {type: 'Emergency Shelter', title: 'Emergency Shelter'},
                        {type: 'Transitional Housing', title: 'Transitional Housing'},
                        {type: 'Safe Havens', title: 'Safe Havens'}
                    ]
                }
            }
        ]);
        ...
        mainfieldset.add([
            ...
            },
            {
                ...
                itemId: 'age_range',
                name: 'age_range',
                label: 'If hesitant, ask<br/>\"Are you...\"',
        ...
        this.add([
            ...
            {
                xtype: 'fieldset',
                title: 'Just a few more<br/>Questions',
                defaults: {labelAlign: 'top', labelWrap: true},
                items: [
                    {
                        xtype: 'selectfield',
